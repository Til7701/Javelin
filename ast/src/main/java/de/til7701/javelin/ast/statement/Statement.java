...
public sealed interface Statement extends Node permits ConstructorCall, Expression, InstanceMethodCall, StaticMethodCall, Assignment, Import, ReturnStatement, StatementList, VariableInitialization, WhenStatement {
}
